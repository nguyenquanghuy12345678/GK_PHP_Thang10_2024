...
if (isset($_POST["upload_product"])) {
	...
	$query = "INSERT INTO tbl_product (name, price, image) VALUES (:name, :price, :image)";
...
if (isset($_GET["upload_success"])) {
	$message = '<div class="alert alert-success">Product uploaded successfully!</div>';
}
...
<body>
	...
	<!-- phan khac -->
	<div class="container">
        <h3 align="center">Upload New Product</h3>
        <form method="post" enctype="multipart/form-data">
            ...
            <input type="submit" name="upload_product" class="btn btn-primary" value="Upload Product" />
        </form>
        <?php echo $message; ?>
    </div>
	<!-- phan them -->
